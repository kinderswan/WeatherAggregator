...
namespace WeatherAggregator.Rest
{
	public class RestResponse<T> : IRestResponse<T>
	{
		...
		{
            log.InfoFormat(CultureInfo.InvariantCulture, "GetDataFromResponseContent has been called");
		...
		{
            log.InfoFormat(CultureInfo.InvariantCulture, "JsonTryDeserialize has been called");
