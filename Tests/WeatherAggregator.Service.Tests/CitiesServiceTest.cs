...
namespace WeatherAggregator.Service.Tests
{
	...
	public class CitiesServiceTest
	{
		...
		public void GetCitiesCollection_ShouldReturn_CitiesCollectionModel()
		{
			...
			CitiesCollectionModel result = this.citiesService.GetCitiesCollection("CountryName");
		...
		public void GetCitiesStateCollection_ShouldReturn_CitiesCollectionModel()
		{
			...
			CitiesCollectionModel result = this.citiesService.GetCitiesCollection("CountryName", "StateName");
			...
			this.citiesRepositoryMock.Verify(
				x => x.GetCitiesCollection(It.Is<string>(y => y == "CountryName"), It.Is<string>(z => z == "StateName")), Times.Once);
		}
